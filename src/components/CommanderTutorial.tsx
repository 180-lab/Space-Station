...
export const CommanderTutorial: React.FC<CommanderTutorialProps> = ({
  ...
  const rawTasks: TutorialTask[] = [
    ...
    {
      id: 8,
      title: '🏦 Materials Repository Level 10',
      ...
      hint: 'Upgrade the Materials Repository building under your XPL tab infrastructure list.',
      howToGetThere: '1. Open the <strong>XPL</strong> tab.<br/>2. Locate the <strong>Materials Repository</strong> building slot in the infrastructure grid.<br/>3. Upgrade it to Level 10 or higher (use Speed Credits to complete instantly if desired).',
      commanderTip: 'XPL tab -> Base Infrastructure Buildings -> Materials Repository.',
    ...
    },
    {
      ...
      hint: 'Under the RDR (Galaxy) tab, select another player coordinate on the map, click "Transmit Resources", select any amount and dispatch.',
      howToGetThere: '1. Open the <strong>RDR</strong> tab.<br/>2. Select another commander station node from leaderboards or the coordinate scanner.<br/>3. Click <strong>"Transmit Resources"</strong> to open the Cargo link.<br/>4. Select at least 1 unit of resource and click <strong>"Transmit Resource Shipment"</strong>.',
      commanderTip: 'RDR tab map coordinates -> Click Player node -> Transmit Resources.',
    ...
    },
    {
      ...
      hint: 'Under the RDR (Galaxy) tab map, find any player coordinate. Choose "Attack Planet", select at least 1 combat unit, and dispatch flight travel.',
      howToGetThere: '1. Navigate to the <strong>RDR</strong> tab.<br/>2. Choose any coordinate or space outpost on the map view.<br/>3. Click <strong>"Deploy Fleet / Attack Planet"</strong>.<br/>4. Set military action type to <strong>"Attack"</strong>, allocate combat troops, and click <strong>"Confirm & Dispatch"</strong>.',
      commanderTip: 'RDR tab -> Click on Sector Nodes -> Settle / Deploy Fleet command overlay.',
    ...
    },
    {
      ...
      requirementHtml: 'Perform a <strong>sector grid scanner scan</strong> under the RDR tab.',
      hint: 'Navigate to the RDR (Galaxy) tab, check your scan coordinates, and click on scan node or search to run telemetry diagnostics.',
      howToGetThere: '1. Open the <strong>RDR</strong> tab.<br/>2. Look at the **Galaxy Grid Sector Scanner** card.<br/>3. Input target coordinates or leave default, and click the blue <strong>"EXECUTE GALAXY RADAR SCAN"</strong> button.',
      commanderTip: 'RDR tab -> "Galaxy Grid Sector Scanner" widget.',
    ...
    },
    {
      ...
      hint: 'Locate the Army Base row in your XPL tab buildings array, and click Upgrade/Build.',
      howToGetThere: '1. Navigate to the <strong>XPL</strong> tab.<br/>2. Find the <strong>Army Base</strong> slot in base buildings grid.<br/>3. Trigger the <strong>"Upgrade Building"</strong> sequence to build Level 1 barracks.',
      commanderTip: 'XPL tab -> Base Infrastructure Buildings -> Army Base card.',
      ...
      encouragementQuote: 'Magnificent tactical wisdom! Space is a hostile abyss - having a robust local defensive army base protects your logistics caches.',
      targetTab: 'explore',
      rewards: {
    ...
    },
    {
      ...
      hint: 'Open the CMD tab (must have level 1 Army Base), choose any troop types such as Interceptors or Assault Fighters, enter recruiting amounts, and click train.',
      howToGetThere: '1. Navigate to the <strong>CMD</strong> tab.<br/>2. Scroll to the <strong>Troop Recruiter</strong> rows.<br/>3. Select <strong>"Interceptor Drone"</strong>, enter "15" in the quantity recruitment box, and click <strong>"Train Military Troops"</strong>.',
      commanderTip: 'CMD tab -> Recruit Troop Garrison console panel.',
    ...
    {
      id: 22,
      title: '✈️ Recruit Interceptor Drones',
      ...
      hint: 'Ensure your Army Base is Level 1, navigate to CMD tab, input 5 or higher in the Interceptor block, and click Train.',
      howToGetThere: '1. Navigate to the <strong>CMD</strong> tab.<br/>2. Identify the **Interceptor Drone (Defender)** troop recruiter row.<br/>3. Input **5** or higher and select **Train Military Troops**.',
      commanderTip: 'CMD tab -> Recruit Interceptor Drones.',
    ...
    {
      id: 23,
      title: '🛸 Recruit Assault Fighters',
      ...
      hint: 'Go to the CMD tab, look for Assault Fighter (Attacker) and initiate training of at least 2 military starfighters.',
      howToGetThere: '1. Navigate to the <strong>CMD</strong> tab.<br/>2. Find the <strong>Assault Fighter (Attacker)</strong> recruit slot.<br/>3. Order a batch of **2** or more starships.',
      commanderTip: 'CMD tab -> Recruit Assault Fighters.',
      congratsMessage: '🛸 ATTACK PAYLOADS SECURED! Heavy assault fighters are fully fueled and stationed in launch bays, awaiting destination warp coordinates!',
      encouragementQuote: 'Brilliant expansion! Assault Fighters deal immense structural damage to target planetary shield grids.',
      targetTab: 'army',
      rewards: {
        resources: { water: 12000, plasma: 12000, fuel: 12000, food: 12000, respirant: 12000 },
        credits: 6000,
