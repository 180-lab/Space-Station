  ...
  const rawTasks: TutorialTask[] = [
    {
      ...
      hint: 'Go to the Home tab, find the Fabricator under Base Infrastructure Buildings, and click Upgrade.',
      howToGetThere: '1. Go to the <strong>Home</strong> tab.<br/>2. Find the <strong>Fabricator</strong> in the Base Infrastructure Buildings list.<br/>3. Click <strong>"Upgrade Building"</strong> to start construction.',
    ...
    },
    {
      ...
      hint: 'Go to the Home tab, scroll to Resource Extractor Outposts, and click Construct Extractor on every resource type with level 0.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Scroll down to <strong>"RESOURCE EXTRACTOR OUTPOSTS"</strong>.<br/>3. Click <strong>"Construct Extractor"</strong> on all 5 types of pumps (Water, Plasma, Fuel, Food, Respirant).',
    ...
    },
    {
      ...
      hint: 'Under the Home tab, find the Communications Hub in the Infrastructure list and upgrade it.',
      howToGetThere: '1. Go to the <strong>Home</strong> tab.<br/>2. Scroll to the Base Infrastructure Buildings list.<br/>3. Select <strong>Communications Hub</strong> and click <strong>"Upgrade Building"</strong>.',
    ...
    },
    {
      ...
      hint: 'Find the Repository building under Infrastructure inside the Home tab and start construction.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Find the <strong>Repository (Silo)</strong> under Base Infrastructure Buildings.<br/>3. Click <strong>"Upgrade Building"</strong> to establish physical storage tanks.',
    ...
    },
    {
      ...
      hint: 'Under the Home tab infrastructure, select your Fabricator and click Queue Upgrade or Upgrade Building.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Find the <strong>Fabricator</strong>.<br/>3. Start the upgrade directly, or if another building is active, use Space Gold to click <strong>"Queue Upgrade"</strong>.',
    ...
    },
    {
      ...
      hint: 'Under the Home tab infrastructure, locate the Radar Array and upgrade it.',
      howToGetThere: '1. Go to the <strong>Home</strong> tab.<br/>2. Scroll down to Base Infrastructure Buildings.<br/>3. Locate the <strong>Radar Array</strong> and click <strong>"Upgrade Building"</strong>.',
    ...
    },
    {
      ...
      hint: 'Go to Home, find each pump type, and click Upgrade Extractor.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Look for Water, Plasma, Fuel, Food, and Respirant extractors.<br/>3. Click <strong>"Upgrade Extractor"</strong> on all 5 to level them up to Level 2.',
    ...
    },
    {
      ...
      hint: 'Go to the Home tab, find the Fabricator under Base Infrastructure Buildings, and click Upgrade or Queue Upgrade to Level 4.',
      howToGetThere: '1. Go to the <strong>Home</strong> tab.<br/>2. Find the <strong>Fabricator</strong> in the Base Infrastructure Buildings list.<br/>3. Click <strong>"Upgrade Building"</strong> or <strong>"Queue Upgrade"</strong> to upgrade it to Level 4.',
    ...
    },
    {
      ...
      hint: 'Go to Home, find the Communications Hub under Base Infrastructure, and upgrade it to Level 2.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Find the <strong>Communications Hub</strong> under Base Infrastructure Buildings.<br/>3. Click <strong>"Upgrade Building"</strong> to upgrade it to Level 2.',
    ...
    },
    {
      ...
      hint: 'Now that Fabricator is Level 4, go to Home and construct the Research Center.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Scroll down to infrastructure buildings.<br/>3. Select <strong>Research Center</strong> and click <strong>"Upgrade Building"</strong>.',
    ...
    },
    {
      ...
      hint: 'Find the Research Center in Home and click Upgrade.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Locate the <strong>Research Center</strong> building.<br/>3. Upgrade it to Level 2.',
    ...
    },
    {
      ...
      hint: 'Under Home, click Upgrade Extractor on all five resource outpost nodes.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Locate Water, Plasma, Fuel, Food, and Respirant extractors.<br/>3. Upgrade each pump to Level 3.',
    ...
    },
    {
      ...
      hint: 'Find the Fabricator under Home and click Upgrade to Level 7.',
      howToGetThere: '1. Go to the <strong>Home</strong> tab.<br/>2. Find the <strong>Fabricator</strong> in infrastructure buildings.<br/>3. Click <strong>"Upgrade Building"</strong> to raise it to Level 7.',
    ...
    },
    {
      ...
      hint: 'Go to Home, select the Communications Hub, and upgrade it to Level 3.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Scroll to <strong>Communications Hub</strong> and initiate the Level 3 upgrade sequence.',
    ...
    },
    {
      ...
      hint: 'Find your Radar Array under Home and upgrade it to Level 2.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Find the <strong>Radar Array</strong> under Base Infrastructure.<br/>3. Click <strong>"Upgrade Building"</strong> to raise it to Level 2.',
    ...
    },
    {
      ...
      hint: 'Under the Home tab, locate the Army Base building slot and start construction.',
      howToGetThere: '1. Go to the <strong>Home</strong> tab.<br/>2. Find <strong>Army Base (War Room)</strong> under infrastructure buildings.<br/>3. Click <strong>"Upgrade Building"</strong> to establish the command deck.',
    ...
    },
    {
      ...
      hint: 'Go to the Home tab, find any resource extractor outpost category, and click "⚡ Boost", or select the Standalone Production Overdrive Card.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Locate the <strong>RESOURCE EXTRACTOR OUTPOSTS</strong> or the standalone <strong>Production Boost</strong> card.<br/>3. Select <strong>"⚡ Boost"</strong>, choose a duration, and deploy the booster using Space Gold.',
    ...
    },
    {
      ...
      hint: 'Go to the Home tab, find any resource extractor outpost category, and click "⚡ Boost" to supercharge its output.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Scroll down to <strong>"RESOURCE EXTRACTOR OUTPOSTS"</strong>.<br/>3. Click the <strong>"⚡ Boost"</strong> button next to any of your extractor pumps and confirm overdrive deployment.',
      commanderTip: 'Overdrive boosts multiply resource extraction hourly output by +14%, securing massive reserves rapidly.',
    ...
    },
    {
      ...
      hint: 'Under Home, select your Silo building and upgrade it to Level 5.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Find the <strong>Repository (Silo)</strong> under Infrastructure Buildings.<br/>3. Upgrade it to Level 5.',
    ...
    },
    {
      ...
      hint: 'Bring your Fabricator to maximum Level 10 under the Home tab.',
      howToGetThere: '1. Go to the <strong>Home</strong> tab.<br/>2. Find the <strong>Fabricator</strong> and click <strong>"Upgrade Building"</strong> to reach maximum Level 10.',
    ...
    },
    {
      ...
      hint: 'Under Home, find the War Room (Army Base) and upgrade it to Level 2.',
      howToGetThere: '1. Navigate to the <strong>Home</strong> tab.<br/>2. Find the <strong>Army Base (War Room)</strong> in infrastructure.<br/>3. Click <strong>"Upgrade Building"</strong> to level 2.',
    ...
    },
    {
      ...
      hint: 'Go to Home, select the Research Center, and click Upgrade to Level 3.',
      howToGetThere: '1. Go to the <strong>Home</strong> tab.<br/>2. Locate the <strong>Research Center</strong> under infrastructure.<br/>3. Click <strong>"Upgrade Building"</strong> to begin constructing Level 3 labs.',
    ...
    },
    {
      ...
      hint: 'Now that Fabricator is Level 10, construct the Bunker under Base Infrastructure Buildings inside the Home tab.',
      howToGetThere: '1. Open the <strong>Home</strong> tab.<br/>2. Locate the <strong>Bunker</strong> slot under infrastructure buildings.<br/>3. Click <strong>"Upgrade Building"</strong> to construct the vault.',
    ...
    },
    {
      ...
      hint: 'First, train a Settlement Ship in the CMD tab. Open the GLXY tab, locate a green dot marked "Habitable Planet", select it, assign the Settlement Ship, and click dispatch. Once arrived, select it in the Home tab dropdown!',
